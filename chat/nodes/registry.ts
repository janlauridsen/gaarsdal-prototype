...
export const nodeRegistry: Record<string, Node> = {
  ...
  GEN_HYPNO: {
    ...
    meta_domains_written: [
      ...
      "selvrefleksion.active",
      "selvrefleksion.ctx",
      "selvrefleksion.turns",
      "wot.arousal_score",
      "wot.arousal_level",
      "gen_hypno.model",
    ],
  ...
  HOME_ALCOHOL: {
    ...
    meta_domains_written: [
      "ux",
      "gen_alcohol.transcript",
      "gen_alcohol.last_topic",
      "gen_alcohol.problem_title",
      "gen_alcohol.problem_summary",
      "gen_alcohol.topic_tags",
      "gen_alcohol.assistant_turn_count",
      "gen_alcohol.analysis",
      "dialog.mode",
      "dialog.move",
      "dialog.investigation_focus",
      "dialog.stage",
