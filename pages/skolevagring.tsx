      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
            ...
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#555", lineHeight: 1.7 }}>Hver gang barnet slipper for det frygtsomme, bekræfter hjernen, at faren var reel. Undgåelsen giver kortvarig lettelse men fastlåser angsten. Over tid udvides det barnet ikke kan klare. Barnet vælger det ikke. Mønsteret kører af sig selv.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "700px" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7, margin: 0 }}>Når angstreaktionen er dæmpet, bygges tilbagevenden op trin for trin, ofte i samarbejde med skolen. Hypnoterapien gør trinene mulige ved at ændre den automatiske reaktion; skolen og I som forældre skaber rammerne. De to ting arbejder sammen.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <Link href="/praestationsangst-born" style={{ fontSize: "14px", color: "#5a7a8f", textDecoration: "none", padding: "6px 14px", border: "1px solid #5a7a8f", borderRadius: "20px" }}>Præstationsangst</Link>
