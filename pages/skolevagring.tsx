  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="description" content="Dit barn vil ikke i skole. Mavepine, gråd, panik om morgenen. Hypnoterapi arbejder med angsten der sidder bag skolevægring. Jan Gaarsdal, Birkerød." />
        ...
        <meta property="og:description" content="Dit barn vil ikke i skole. Mavepine, gråd, panik om morgenen. Hypnoterapi arbejder med angsten der sidder bag skolevægring. Jan Gaarsdal, Birkerød." />
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "18px", color: "#555", maxWidth: "660px" }}>Morgenerne er kaos. Mavepine, gråd, panik. Dit barn er ikke doven og lyver ikke. Noget ved skolen udløser en reel angstreaktion. Og den kan ikke tales væk.</p>
        </section>
        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "15px", color: "#555", maxWidth: "700px" }}>Hypnoterapi arbejder med den automatiske angstreaktion der sidder bag skolevægringen, ikke med selve skolen. Mange børn oplever markant bedring efter 1-2 sessioner.</p>
        </section>
