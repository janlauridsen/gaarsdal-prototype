...
export default function PriserPage() {
  return (
    <>
      <Header />
      <Head>
        <title>Priser på hypnoterapi Birkerød | Gaarsdal</title>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              name: "Priser på hypnoterapi",
              description: "Priser på hypnoterapi hos Jan Gaarsdal i Birkerød. Gratis forsamtale. Pakker til studerende, arbejdsløse og flygtninge. Første session 900 kr.",
              url: "https://gaarsdal.net/priser",
              provider: {
                "@type": "Person",
                name: "Jan Gaarsdal",
