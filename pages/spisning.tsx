    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#2C2A28" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          <h1 style={{ fontSize: "32px", fontWeight: 600, lineHeight: 1.3, letterSpacing: "-0.01em", marginBottom: "20px" }}>Det er ikke sult der driver det</h1>
          <p style={{ fontSize: "19px", lineHeight: 1.65, color: "#4A463F", marginBottom: "18px", maxWidth: "700px" }}>Du ved godt, hvornår du spiser på følelserne. Det er kedsomhed, stress, uro, ensomhed. Maden dæmper det i et øjeblik. Bagefter er der skam oveni. Du har prøvet at lade være. Det virker ikke konsekvent.</p>
          <p style={{ fontSize: "17px", lineHeight: 1.7, color: "#4A463F", maxWidth: "700px" }}>Følelsesspisning er ikke svag viljestyrke. Det er en reguleringsmekanisme der sidder dybere end beslutninger kan nå.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Hjernen har lært at mad dæmper ubehag hurtigt og pålideligt. Den reaktion kører automatisk og er stærkere end beslutningen om at lade være, i det øjeblik ubehaget opstår. Det er ikke grådighed. Det er en lært kobling.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Skam forstærker mønsteret</h3>
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Skam efter overspisning øger det ubehag, der drev spisningen i første omgang. Det skaber en cirkel: ubehag, spiser, skam, mere ubehag. Viljestyrke og selvkritik bryder ikke cirklen, de forstærker den.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Restriktioner virker ikke langsigtet</h3>
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>At begrænse madvarer eller kalorier adresserer ikke det underliggende behov. Hjernen finder andre måder at dække behovet på, eller øger trangen til præcis det der er forbudt.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Hypnoterapi arbejder med det underliggende behov der driver spisningen, ikke med maden i sig selv. Når hjernen finder andre måder at regulere ubehaget, falder trangen naturligt. Ingen restriktioner, ingen viljestyrke.</p>
          <p style={{ fontSize: "16px", color: "#6B675F", maxWidth: "700px", lineHeight: 1.7 }}>Jan tilpasser sin tilgang til, hvad der driver dit specifikke mønster, om det primært er stress, kedsomhed, ensomhed eller noget andet.</p>
        </section>


        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Sådan arbejder hypnose med følelsesspisning</h2>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Følelsesspisning er en reguleringsmekanisme. Det er ikke sult, der driver den, men kedsomhed, stress, uro eller ensomhed, og maden dæmper ubehaget i et øjeblik. Hjernen har lært, at mad virker hurtigt og pålideligt, og den reaktion kører automatisk, stærkere end beslutningen om at lade være i det øjeblik ubehaget opstår.</p>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Hypnose arbejder med det underliggende behov, der driver spisningen, ikke med maden i sig selv. Når hjernen finder andre måder at regulere ubehaget på, falder trangen naturligt. Der er ingen restriktioner og ingen kamp mod maden, fordi det ikke er maden, der er problemet.</p>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Det er forskellen på en diæt og reel forandring. En diæt bekæmper symptomet med viljestyrke og udløser ofte endnu mere trang. Hypnoterapien retter sig mod årsagen, så behovet for at spise på følelserne aftager.</p>
          <p style={{ fontSize: "16px", color: "#6B675F", maxWidth: "700px", lineHeight: 1.7 }}>Samtidig arbejdes der med den skam, der ofte følger efter, fordi skammen i sig selv skaber den uro, der udløser næste episode.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "700px" }}>
            <div>
              ...
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Du spiser, selvom du ikke er sulten. Trangen kommer pludseligt, ofte efter en følelse: stress, kedsomhed, skuffelse. Det er et signal om regulering, ikke om næring.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Bestemte følelser, bestemt mad</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Det er sjældent tilfældigt hvad der spises. Søde eller fede ting dæmper hurtigst, og hjernen ved det. Trangen er målrettet, fordi den tjener et formål: at ændre hvordan du har det lige nu.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Skammen bagefter</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Efter episoden kommer skylden og skammen. Den følelse skaber ny uro, som igen kan udløse trang. Det bliver en cirkel, hvor selvbebrejdelsen holder mønsteret kørende.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Det sker oftest alene</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Følelsesspisning foregår typisk i det skjulte, om aftenen, alene. Det gør det ensomt og svært at tale om, og mange bærer på det i årevis uden at fortælle nogen det.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "60px", padding: "28px 32px", background: "#F7F1E8", borderRadius: "10px", border: "1px solid #E6D9C2" }}>
          ...
          <p style={{ fontSize: "16px", color: "#4A463F", maxWidth: "700px", margin: 0, lineHeight: 1.7 }}>Denne side handler om følelsesmæssig spisning og overspisning. Ved tegn på en egentlig spiseforstyrrelse som anoreksi, bulimi eller tvangsoverspisning skal du altid starte hos din læge eller et specialiseret behandlingstilbud. Spiseforstyrrelser kan være alvorlige og kræver tværfaglig behandling, hvor hypnoterapi højst er et supplement.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Kan hypnose hjælpe mod følelsesspisning?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Ja. Hypnoterapi arbejder med det underliggende behov der driver spisningen, ikke med maden i sig selv. Når hjernen finder andre måder at regulere ubehaget på, falder trangen naturligt, uden restriktioner eller viljestyrke.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Hvorfor kan jeg ikke bare lade være med at spise på følelserne?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Fordi hjernen har lært at mad dæmper ubehag hurtigt og pålideligt. Den reaktion kører automatisk og er stærkere end beslutningen om at lade være i det øjeblik ubehaget opstår. Det er en lært kobling, ikke svag vilje.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Skal jeg på en diæt?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Nej. Hypnoterapi mod følelsesspisning handler ikke om kost eller restriktioner, men om at adressere det behov maden dækker. Restriktioner adresserer ikke årsagen og kan endda øge trangen.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Hvornår er det mere end følelsesspisning?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Ved tegn på en egentlig spiseforstyrrelse som anoreksi, bulimi eller tvangsoverspisning skal du altid starte hos din læge eller et specialiseret behandlingstilbud. Hypnoterapi er her højst et supplement, ikke den primære behandling.</p>
            </div>
          </div>
        </section>
