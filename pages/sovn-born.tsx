...
export default function Page() {
  return (
    <>
      <Header />
      <Head>
        <title>Søvnproblemer hos børn, Birkerød | Gaarsdal</title>
        <meta name="description" content="Dit barn sover dårligt, bekymrer sig om natten og er træt i skolen. Hypnoterapi arbejder med nervesystemet bag søvnproblemerne. Jan Gaarsdal, Birkerød." />
        <link rel="canonical" href="https://gaarsdal.net/sovn-born" />
        <meta property="og:title" content="Søvnproblemer hos børn og unge, hypnoterapi Birkerød | Gaarsdal" />
        <meta property="og:description" content="Dit barn sover dårligt, bekymrer sig om natten og er træt i skolen. Hypnoterapi arbejder med nervesystemet bag søvnproblemerne. Jan Gaarsdal, Birkerød." />
        <meta property="og:image" content="https://gaarsdal.net/og-jan-gaarsdal.jpg" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://gaarsdal.net/sovn-born" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "MedicalWebPage",
              name: "Søvnproblemer hos børn og unge",
              description: "Dit barn sover dårligt, bekymrer sig om natten og er træt i skolen. Hypnoterapi arbejder med nervesystemet bag søvnproblemerne. Jan Gaarsdal, Birkerød.",
              url: "https://gaarsdal.net/sovn-born",
              provider: {
                "@type": "Person",
                name: "Jan Gaarsdal",
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#2C2A28" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          <h1 style={{ fontSize: "32px", fontWeight: 600, lineHeight: 1.3, letterSpacing: "-0.01em", marginBottom: "20px" }}>Dit barn kan ikke falde i søvn og bekymrer sig om natten</h1>
          <p style={{ fontSize: "19px", lineHeight: 1.65, color: "#4A463F", marginBottom: "18px", maxWidth: "700px" }}>Barnet vil ikke i seng. Eller lægger sig men ligger vågen i timevis. Tankerne kører. Det vågner kl. 3 og kan ikke falde i søvn igen. Det er træt i skolen, har svært ved at koncentrere sig og er lettere irritabelt. Du er bekymret og ved ikke hvad du skal gøre.</p>
          <p style={{ fontSize: "17px", lineHeight: 1.7, color: "#4A463F", maxWidth: "700px" }}>Søvnproblemer hos børn handler sjældent om søvnhygiejne alene. De handler om et nervesystem der ikke slipper ned.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Hjernen arbejder med associationer. Hvis barnet gentagne gange har ligget vågent og bekymret sig i sengen, lærer hjernen, at sengen er et sted med uro. Den automatiske reaktion er aktivering, ikke afslapning. Det kan ikke ændres med gode rutiner alene.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Bekymringer om natten er ikke tilfældige</h3>
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Hjernen fylder stilheden med simulering og problemløsning. For børn med en grundlæggende angst forstærkes dette om natten, når der ikke er distrationer. Søvnproblemet er et symptom på den underliggende tilstand.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Søvnmangel forværrer alt andet</h3>
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Forskning viser, at søvnmangel hos børn direkte påvirker indlæring, emotionel regulering og immunforsvar. Et barn der sover dårligt har sværere ved at håndtere det der er svært i dagtimerne. Søvn og trivsel er tæt forbundet.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#F5F3EE", borderRadius: "10px" }}>
          ...
          <p style={{ fontSize: "16px", marginBottom: "12px", lineHeight: 1.7 }}>Søvnproblemer hos børn og unge er stigende i Danmark. Sundhedsstyrelsen vurderer, at op mod 20 pct. af børn og unge oplever søvnproblemer. Hypnoterapi er undersøgt som metode ved søvnproblemer hos unge, blandt andet i American Journal of Clinical Hypnosis.</p>
          <p style={{ fontSize: "16px", color: "#6B675F", fontStyle: "italic", lineHeight: 1.7 }}>Kilde: <a href="https://www.sst.dk" target="_blank" rel="noopener" style={{ color: "#5A7049", textDecoration: "underline" }}>Sundhedsstyrelsen.dk</a>, European Sleep Research Society, American Journal of Clinical Hypnosis.</p>
        </section>

        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Hypnoterapi arbejder direkte med nervesystemets evne til at slippe ned i ro. Barnet lærer at lede sig selv mod søvn, ikke som en teknik, det skal huske, men som en ny automatisk reaktion. Mange børn oplever mærkbar bedring hurtigt.</p>
          <p style={{ fontSize: "16px", color: "#6B675F", maxWidth: "700px", lineHeight: 1.7 }}>Jan tilpasser sit arbejde til om søvnproblemet primært handler om indsovning, opvågning, bekymringer eller en kombination. Forældrene er altid en del af forløbet.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Barnet hører alt, husker det der sker, og har fuld kontrol undervejs. De fleste børn beskriver det som rart og afslappende, og for søvn er det særligt brugbart. Barnet lærer i sessionen den tilstand, det skal kunne finde frem i sengen derhjemme.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>De typiske søvnmønstre hos børn</h2>
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "700px" }}>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Barnet kan ikke falde i søvn</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Timer i sengen, mange opkald på forældre, vand, toilet, "jeg kan ikke sove". Ofte er sengen blevet koblet til kamp og frustration i stedet for ro. Hypnoterapien giver barnet en konkret indre vej til at slippe ned, og afkobler sengen fra kampen.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Bekymringer holder barnet vågent</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Mørket og stilheden giver bekymringerne frit løb: tanker om døden, skolen, om noget sker med jer. Det er ofte angst der viser sig ved sengetid, fordi dagens distraktioner forsvinder. Her arbejdes der med både søvnen og bekymringsmønsteret bag.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Opvågninger og mareridt</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Barnet vågner om natten og kan ikke selv falde i søvn igen, eller plages af tilbagevendende mareridt. Hypnoterapi kan arbejde direkte med mareridtets indhold, børn kan lære at "ændre slutningen", og med evnen til selv at finde tilbage til søvnen.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Teenagere med forskudt søvn</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Døgnrytmen er skredet, skærmen fylder, og morgenvækningen er en daglig konflikt. Hos teenagere kombineres arbejdet med søvnmekanismen ofte med de bagvedliggende mønstre: stress, præstationspres eller skærmvaner.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "60px", padding: "28px 32px", background: "#F7F1E8", borderRadius: "10px", border: "1px solid #E6D9C2" }}>
          ...
          <p style={{ fontSize: "16px", color: "#4A463F", maxWidth: "700px", margin: 0, lineHeight: 1.7 }}>Ved mistanke om søvnapnø (snorken med vejrtrækningspauser), natlige anfald eller hvis søvnproblemet ledsages af tydelig mistrivsel, skal I altid kontakte egen læge først, så fysiske årsager udelukkes. Hypnoterapi arbejder med de mønster- og uro-drevne søvnproblemer.</p>
        </section>
        ...
        <section style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <Link href="/sovn" style={{ fontSize: "14px", color: "#5A7049", textDecoration: "none", padding: "6px 14px", border: "1px solid #5A7049", borderRadius: "20px" }}>Søvnproblemer, voksne</Link>
