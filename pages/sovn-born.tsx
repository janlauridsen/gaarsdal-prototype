...
export default function Page() {
  return (
    <>
      <Header />
      <Head>
        <title>Søvnproblemer hos børn og unge | Gaarsdal Birkerød</title>
        <meta name="description" content="Dit barn sover dårligt, bekymrer sig om natten og er træt i skolen. Hypnoterapi arbejder med nervesystemet der holder barnet vågent. Jan Gaarsdal, Birkerød." />
        <link rel="canonical" href="https://gaarsdal.net/sovn-born" />
        <meta property="og:title" content="Søvnproblemer hos børn og unge | Gaarsdal Birkerød" />
        <meta property="og:description" content="Dit barn sover dårligt, bekymrer sig om natten og er træt i skolen. Hypnoterapi arbejder med nervesystemet der holder barnet vågent. Jan Gaarsdal, Birkerød." />
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "18px", color: "#555", maxWidth: "660px" }}>Barnet vil ikke i seng. Eller lægger sig men ligger vågen. Tankerne kører. Det vågner om natten og kan ikke falde i søvn igen. Det er træt i skolen og har svært ved at koncentrere sig.</p>
        </section>
        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "15px", color: "#555", maxWidth: "700px" }}>Hypnotisk tilstand og søvn aktiverer de samme neurologiske mekanismer. Barnet lærer at lede sig selv ned i ro. Det er en reel neurologisk ændring, ikke en teknik der skal huskes.</p>
        </section>
