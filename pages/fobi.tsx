    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Fobier er et af de områder Jan arbejder mest med. Arbejdet sker direkte med den lærte reaktion og erstatter den med ro. Tilgangen er en anden end gradvis eksponering: der arbejdes direkte med den automatiske respons.</p>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Fobier er et af de områder hypnose bruges mest til, fordi den arbejder netop dér, hvor reaktionen sidder. I stedet for gradvis eksponering, hvor du udsættes for frygten igen og igen, eller rationalisering, hvor du forsøger at tænke dig fra den, ændres selve den automatiske respons ved kilden.</p>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div style={{ borderBottom: "1px solid #eee", paddingBottom: "16px" }}>
              ...
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7 }}>Ja. Fobier er et af de områder Jan arbejder mest med. Arbejdet sker direkte med den lærte frygtreaktion og erstatter den med ro, ikke ved gradvis eksponering eller rationalisering, men ved at ændre den automatiske respons ved kilden.</p>
            </div>
            <div style={{ borderBottom: "1px solid #eee", paddingBottom: "16px" }}>
