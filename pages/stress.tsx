        ...
        <section style={{ marginBottom: "60px", padding: "28px 32px", background: "#E8EBE2", borderRadius: "10px", borderLeft: "3px solid #5A7049" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              ...
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Mindfulness træner din bevidste opmærksomhed. Hypnoterapi arbejder direkte med de automatiske reaktioner under bevidst tænkning. De kan supplere hinanden, men hypnose når et dybere lag.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
