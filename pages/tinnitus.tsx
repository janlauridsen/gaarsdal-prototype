      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#2C2A28" }}>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#F5F3EE", borderRadius: "10px" }}>
          ...
          <p style={{ fontSize: "16px", color: "#6B675F", fontStyle: "italic", lineHeight: 1.7 }}>
            Kilde: <a href="https://hoereforeningen.dk" target="_blank" rel="noopener" style={{ color: "#5A7049", textDecoration: "underline" }}>Høreforeningen.dk</a>, British Tinnitus Association, Netdoktor.dk.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "700px" }}>
            <div>
              ...
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Mange beskriver at lyden stiger og falder i takt med stress, søvnmangel og koncentrationskrav. Stille miljøer og sengelejet er ofte de sværeste. Her kan hypnoterapi hjælpe med at bryde koblingen mellem stilhed og forværring.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Tinnitus opstod efter støj, medicin eller stress</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Uanset årsagen til tinnitusen er det hjernens nuværende reaktion der bestemmer, hvor meget den fylder. Oprindelsen ændrer ikke hvilken tilgang der virker - det er reaktionsmønsteret der skal arbejdes med.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Søvnen er påvirket</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Tinnitus og søvnproblemer følges ofte ad. Stilheden om natten giver lyden frit spil, og træthed forværrer igen tinnitusen. Hypnoterapi arbejder med begge - og mange oplever at søvnen bedres som den første synlige effekt.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Du er holdt op med ting du holdt af</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Koncerter, biografer, støjende selskaber - steder du undgår fordi lyden bagefter er uudholdelig. Tilpasninger der over tid indsnævrer livet. Det er ikke nødvendigvis en permanent præmis.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <Link href="/ibs-spaendinger" style={{ fontSize: "14px", color: "#5A7049", textDecoration: "none", padding: "6px 14px", border: "1px solid #5A7049", borderRadius: "20px" }}>IBS og spændinger →</Link>
