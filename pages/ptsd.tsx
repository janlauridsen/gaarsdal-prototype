    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          <h1 style={{ fontSize: "34px", fontWeight: 600, lineHeight: 1.25, marginBottom: "20px" }}>Det er overstået. Men kroppen reagerer som om det sker igen</h1>
          <p style={{ fontSize: "18px", color: "#555", marginBottom: "16px", maxWidth: "660px" }}>En lyd, en lugt, en situation - og pludselig er du tilbage i det. Hjertet hamrer, kroppen er i alarm. Måske uden at du engang bevidst tænker på hændelsen. Du ved at faren er ovre. Men din krop har ikke fået besked.</p>
          <p style={{ fontSize: "16px", color: "#666", maxWidth: "660px" }}>Traumer og PTSD er ikke et spørgsmål om at komme videre ved viljestyrke. Det er lagret i kroppens alarmsystem og de automatiske reaktioner - ikke i den bevidste hukommelse alene.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#f5f7fa", borderRadius: "10px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "12px" }}>Hypnose har en lang klinisk historie i traumebehandling. American Psychological Association (APA) anerkender hypnose som et redskab der kan indgå i behandling af traumer og PTSD. Hypnoterapi fremhæves i APA's Division 30 som evidensbaseret supplement til kognitiv behandling af traume.</p>
          <p style={{ fontSize: "15px", marginBottom: "12px" }}>PTSD er anerkendt som selvstændig diagnose i WHO's ICD-11 (2019) og DSM-5. Forskning viser at effektive traumebehandlinger har til fælles at de adresserer kroppens alarmsystem - ikke kun den bevidste forståelse af hændelsen. Hypnoterapi gør netop dette.</p>
          <p style={{ fontSize: "15px", color: "#666", fontStyle: "italic" }}>Kilde: WHO ICD-11, <a href="https://www.apa.org" target="_blank" rel="noopener" style={{ color: "#5a7a8f", textDecoration: "underline" }}>American Psychological Association</a>, Hammond (2010) American Journal of Clinical Hypnosis.</p>
        </section>

        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør ved traumer</h2>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Hypnoterapi arbejder med traumet der hvor det er lagret - i kroppens alarmsystem og de automatiske reaktioner. I den hypnotiske tilstand er hjernen i en fokuseret, modtagelig tilstand der tillader arbejde med det som ellers er låst fast under bevidst kontrol.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Arbejdet sker skånsomt og i dit tempo. Moderne traumearbejde med hypnose handler ikke om at tvinge dig gennem hændelsen igen - men om at hjælpe nervesystemet med gradvist at slippe sit alarmberedskab og lære at faren er ovre.</p>
          <p style={{ fontSize: "15px", color: "#666", maxWidth: "700px" }}>Jan har erfaring med traumer efter ulykker, overgreb, tab og andre belastende oplevelser. Arbejdet tilpasses altid den enkeltes situation, tempo og behov.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Gratis forsamtale (30 min).</strong> Vi taler om hvad du oplever, hvornår det startede, og hvad du har prøvet. Ingen krav om at gå i detaljer med hændelsen i denne fase. Her afklares om hypnoterapi er den rette tilgang og hvad der er realistisk at forvente.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Første session (90 min).</strong> En grundig samtale om dine reaktioner og dit nervesystems mønster - fulgt af den første hypnose. Tempoet sættes altid af dig. Mange beskriver allerede her en kropslig ro de sjældent mærker.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Opfølgende sessioner (ca. 60 min).</strong> Arbejdet dykker gradvist dybere. For afgrænsede enkelttraumer kan der komme mærkbare resultater relativt hurtigt. Kompleks PTSD fra tidlige erfaringer kræver et længere, mere gradvist forløb.</p>
