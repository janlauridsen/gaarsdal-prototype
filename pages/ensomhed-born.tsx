  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="description" content="Dit barn er ensomt og har svært ved at skabe forbindelser. Hypnoterapi arbejder med selvopfattelsen der driver adfærden. Jan Gaarsdal, Birkerød." />
        ...
        <meta property="og:description" content="Dit barn er ensomt og har svært ved at skabe forbindelser. Hypnoterapi arbejder med selvopfattelsen der driver adfærden. Jan Gaarsdal, Birkerød." />
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "18px", color: "#555", maxWidth: "660px" }}>Det er ikke inviteret med. Det kommer hjem og lukker sig inde. Du spørger hvordan det går, det svarer OK. Du kan se det ikke er OK. Ensomhed hos et barn er en af de sværeste ting at se på som forælder.</p>
        </section>
        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "15px", color: "#555", maxWidth: "700px" }}>Ensomhed handler sjældent om manglende sociale evner. Det handler om en overbevisning om at andre ikke vil have én. Hypnoterapi ændrer den overbevisning indefra.</p>
        </section>
