    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Barnet hører alt, husker det der sker, og har fuld kontrol undervejs. De fleste børn beskriver det som rart og afslappende, og for ensomme børn er selve oplevelsen af at blive mødt, set og forstået i sessionen ofte en del af forandringen.</p>
        </section>
