    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#2C2A28" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          <h1 style={{ fontSize: "32px", fontWeight: 600, lineHeight: 1.3, letterSpacing: "-0.01em", marginBottom: "20px" }}>Du drikker mere end du egentlig vil</h1>
          <p style={{ fontSize: "19px", lineHeight: 1.65, color: "#4A463F", marginBottom: "18px", maxWidth: "700px" }}>Et glas bliver til flere. Hverdagsdrik der snigende er blevet en vane. Du har måske besluttet at skære ned, og det holder et stykke tid, men så er du tilbage. Du er ikke nødvendigvis afhængig, men alkohol fylder mere end du ønsker.</p>
          <p style={{ fontSize: "17px", lineHeight: 1.7, color: "#4A463F", maxWidth: "700px" }}>Det er en af de mest tabubelagte ting at tale om. De fleste søger aldrig hjælp, fordi de hverken føler sig som alkoholikere eller vil i et offentligt system. Men det er præcis i den gråzone, at en tidlig indsats virker bedst.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>For de fleste handler et for stort forbrug ikke om alkoholen i sig selv, men om hvad den gør: dæmper stress, skaber pause, letter uro eller hjælper med at slappe af. Hjernen har lært at alkohol løser noget hurtigt. Den kobling kører automatisk og er stærkere end beslutningen om at lade være.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Triggere styrer mere end viljen</h3>
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Fyraften, weekend, bestemte sociale situationer, en bestemt følelse. Hjernen har koblet disse triggere direkte til alkohol. Det er ikke et bevidst valg i øjeblikket, men en automatisk reaktion. Det forklarer hvorfor det går godt i en periode og så glider tilbage.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Skam og tabu holder folk fast</h3>
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Alkohol er stadig så tabubelagt at mange aldrig søger hjælp. De føler sig hverken som alkoholikere eller vil i offentligt system. Skammen gør problemet usynligt og ensomt, og det forhindrer netop den hjælp der kunne bryde mønsteret tidligt.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "16px", color: "#6B675F", marginBottom: "24px", maxWidth: "700px", lineHeight: 1.7 }}>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#F5F3EE", borderRadius: "10px" }}>
          ...
          <p style={{ fontSize: "16px", marginBottom: "12px", lineHeight: 1.7 }}>Sundhedsstyrelsen vurderer at omkring hver tiende dansker drikker mere end de anbefalede grænser. Anbefalingen er højst 10 genstande om ugen og højst 4 på en dag. Studier i blandt andet American Journal of Clinical Hypnosis peger på at hypnoterapi kan være et effektivt redskab til at ændre alkoholvaner, særligt når det underliggende behov adresseres.</p>
          <p style={{ fontSize: "16px", color: "#6B675F", fontStyle: "italic", lineHeight: 1.7 }}>Kilde: <a href="https://www.sst.dk" target="_blank" rel="noopener" style={{ color: "#5A7049", textDecoration: "underline" }}>Sundhedsstyrelsen.dk</a>, American Journal of Clinical Hypnosis.</p>
        </section>

        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Hypnoterapi arbejder med det behov alkoholen dækker, og med de automatiske koblinger mellem triggere og trang. Ikke med viljestyrke. Når behovet mødes på en anden måde, og koblingerne afkobles, bliver det lettere at træffe og fastholde det valg du egentlig ønsker.</p>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Forløbet er diskret og fordomsfrit. Målet sætter du selv, om det er at drikke mindre, drikke sjældnere eller holde helt op.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Er jeg alkoholiker hvis jeg overvejer hjælp?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Nej. De fleste der søger hjælp befinder sig i gråzonen, hvor alkohol fylder mere end de ønsker, men hvor der ikke er tale om egentlig afhængighed. Du behøver ikke sætte en etikette på dig selv for at have ret til at ændre dit forhold til alkohol.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Skal jeg stoppe helt med at drikke?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Ikke nødvendigvis. Målet sættes ud fra hvad du ønsker, om det er at drikke mindre, drikke sjældnere eller holde helt op. Hypnoterapi arbejder med at gøre det valg lettere at holde fast i, uanset hvad du sigter efter.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Jeg ved godt jeg drikker for meget. Hvorfor kan jeg ikke bare stoppe?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Fordi alkoholvanen sjældent sidder i beslutningen, men i det underliggende behov den dækker, ofte stress, uro eller en måde at slappe af på. At vide at man drikker for meget ændrer ikke det behov. Hypnoterapi arbejder netop der hvor vanen og behovet sidder.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Hvad hvis jeg har prøvet at stoppe før uden held?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Det er normalt. Tidligere forsøg slår ofte fejl, fordi de bygger på viljestyrke alene, mens det underliggende behov forbliver uberørt. Hypnoterapi adresserer behovet, så det bliver lettere at fastholde forandringen.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Er hypnose nok, eller skal jeg også have anden hjælp?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Det afhænger af dit forbrug. Ved egentlig fysisk afhængighed med abstinenser skal du altid starte med din læge eller et misbrugscenter, da afrusning kan kræve lægelig støtte. Hypnoterapi egner sig bedst til gråzonen og som supplement, ikke som erstatning for medicinsk behandling af svær afhængighed.</p>
            </div>
          </div>
        </section>
