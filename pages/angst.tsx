    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#2C2A28" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "17px", lineHeight: 1.7, color: "#4A463F", maxWidth: "700px" }}>Angst er ikke en tankeforstyrrelse. Det er en kropslig tilstand, der aktiveres automatisk, og som rationelle argumenter ikke kan nå ind til.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px", padding: "28px 32px", background: "#E8EBE2", borderRadius: "10px", borderLeft: "3px solid #5A7049" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              ...
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Nej. Hypnose er en naturlig, afslappet tilstand du selv har kontrol over. Du kan ikke fastlåses eller tvinges til noget. Det er en anerkendt psykologisk metode, som blandt andre professor Bobby Zachariae ved Aarhus Universitet har forsket i.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
            ...
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              ...
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Medicin dæmper symptomerne, mens hypnoterapi arbejder med de underliggende mønstre der skaber angsten. Hypnose er en ikke-medicinsk tilgang uden bivirkninger. Ved svær angst bør du altid tale med din læge om den samlede behandling.</p>
            </div>
          </div>
        </section>
