    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
            ...
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#555", lineHeight: 1.7 }}>Kaffe, stress, bestemte tidspunkter, bestemte steder. Hjernen har koblet disse situationer direkte til rygning. Det er ikke et valg i øjeblikket, men en automatisk reaktion på en trigger. Det er derfor, beslutningen ikke er nok alene.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#f5f7fa", borderRadius: "10px" }}>
          ...
          <p style={{ fontSize: "15px", color: "#666", fontStyle: "italic" }}>Kilde: <a href="https://www.sst.dk" target="_blank" rel="noopener" style={{ color: "#5a7a8f", textDecoration: "underline" }}>Sundhedsstyrelsen.dk</a>, <a href="https://www.cancer.dk" target="_blank" rel="noopener" style={{ color: "#5a7a8f", textDecoration: "underline" }}>Kræftens Bekæmpelse</a>.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Det er forskellen på rygestop med hypnose og rygestop med viljestyrke alene: du bekæmper ikke en trang hele dagen, fordi trangen ikke aktiveres på samme måde. Nogle mærker at lysten falder allerede efter de første sessioner, andre har brug for længere tid.</p>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div style={{ borderBottom: "1px solid #eee", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#333" }}>Kan hypnose hjælpe mig med at stoppe med at ryge?</h3>
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7 }}>Ja. Hypnoterapi arbejder direkte med de associationer der driver trangen, ikke med viljestyrken. Hjernen lærer at afkoble triggerne fra reaktionen, og for mange bliver lysten svagere undervejs i forløbet.</p>
            </div>
            <div style={{ borderBottom: "1px solid #eee", paddingBottom: "16px" }}>
            ...
            <div style={{ borderBottom: "1px solid #eee", paddingBottom: "16px" }}>
              ...
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7 }}>Hypnoterapi adresserer det underliggende behov rygningen dækker, så risikoen for at erstatte cigaretter med mad reduceres. Det kan indgå som en del af arbejdet at forebygge vægtøgning.</p>
            </div>
            <div style={{ borderBottom: "1px solid #eee", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#333" }}>Virker hypnose mod rygning hvis jeg har røget i mange år?</h3>
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7 }}>Ja. Antallet af år betyder mindre end man tror, fordi hypnoterapi arbejder med den automatiske kobling, ikke med nikotinens fysiske afhængighed alene. Mange mangeårige rygere stopper med succes.</p>
            </div>
          </div>
        </section>
