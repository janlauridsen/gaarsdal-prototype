...
export default function Page() {
  return (
    <>
      <Header />
      <Head>
        <title>Socialt udenfor, børn og unge | Gaarsdal Birkerød</title>
        <meta name="description" content="Dit barn føler sig udenfor og har svært ved at skabe venskaber. Hypnoterapi arbejder med selvopfattelsen der driver adfærden. Jan Gaarsdal, Birkerød." />
        <link rel="canonical" href="https://gaarsdal.net/social-angst-born" />
        <meta property="og:title" content="Socialt udenfor, børn og unge | Gaarsdal Birkerød" />
        <meta property="og:description" content="Dit barn føler sig udenfor og har svært ved at skabe venskaber. Hypnoterapi arbejder med selvopfattelsen der driver adfærden. Jan Gaarsdal, Birkerød." />
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "18px", color: "#555", maxWidth: "660px" }}>Det er inviteret med men trækker sig. Det har klassekammerater men ingen rigtige venner. Du kan se at det er ensomt men det vil ikke tale om det.</p>
        </section>
        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "15px", color: "#555", maxWidth: "700px" }}>Hypnoterapi arbejder med den grundlæggende overbevisning barnet har om sig selv i andres øjne. Et barn der inderst inde tror det er værd at kende opfører sig anderledes, uden at blive undervist i sociale teknikker.</p>
        </section>
