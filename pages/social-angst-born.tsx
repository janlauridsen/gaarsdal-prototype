    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#2C2A28" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          <h1 style={{ fontSize: "32px", fontWeight: 600, lineHeight: 1.3, letterSpacing: "-0.01em", marginBottom: "20px" }}>Dit barn er der, men føler sig ikke med</h1>
          <p style={{ fontSize: "19px", lineHeight: 1.65, color: "#4A463F", marginBottom: "18px", maxWidth: "700px" }}>Det er inviteret med men trækker sig. Det har klassekammerater men ingen rigtige venner. Det deltager ikke i samtaler og sidder for sig selv i frikvarteret. Du kan se, at det er ensomt men det vil ikke tale om det, eller ved ikke selv, hvad der er galt.</p>
          <p style={{ fontSize: "17px", lineHeight: 1.7, color: "#4A463F", maxWidth: "700px" }}>Sociale vanskeligheder hos børn handler sjældent om manglende sociale evner. Det handler næsten altid om, hvad barnet tror om sig selv i andres øjne.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Børn, der tror, de ikke er værd at kende trækker sig, undgår initiativ og fortolker andres adfærd negativt. Overbevisningen forstærker sig selv. Jo mere barnet trækker sig, jo færre gode erfaringer får det, og jo mere kommer den til at passe.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Det er ikke generthed</h3>
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>Generthed er en temperamentsmæssig disposition. Social angst er en lært frygtreaktion. Barnet ønsker socialt samvær, men frygter det og undgår det. Forskellen er vigtig, fordi løsningen er forskellig.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #E3DFD5", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Sociale teknikker løser det ikke</h3>
              <p style={{ fontSize: "14px", color: "#4A463F", lineHeight: 1.7 }}>At lære barnet at stille spørgsmål og huske navne hjælper ikke, hvis grundoverbevisningen er, at andre ikke bryder sig. Teknikker oven på en negativ selvopfattelse holder ikke. Selvopfattelsen skal ændres ved roden.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#F5F3EE", borderRadius: "10px" }}>
          ...
          <p style={{ fontSize: "16px", marginBottom: "12px", lineHeight: 1.7 }}>Social angst er en af de hyppigste angstlidelser hos børn og unge. Forskning viser, at ubehandlet social angst i barndommen øger risikoen for depression og isolation i voksenlivet. WHO og Sundhedsstyrelsen fremhæver tidlig intervention som afgørende.</p>
          <p style={{ fontSize: "16px", color: "#6B675F", fontStyle: "italic", lineHeight: 1.7 }}>Kilde: <a href="https://www.sst.dk" target="_blank" rel="noopener" style={{ color: "#5A7049", textDecoration: "underline" }}>Sundhedsstyrelsen.dk</a>, WHO Mental Health Atlas, Dansk Institut for Psykiatri.</p>
        </section>

        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Hypnoterapi arbejder direkte med den grundlæggende overbevisning barnet har om sin egen sociale værdi. Et barn, der inderst inde tror, det er værd at kende, opfører sig anderledes, spontant og uden at øve sig. Forandringen kommer indefra.</p>
          <p style={{ fontSize: "16px", color: "#6B675F", maxWidth: "700px", lineHeight: 1.7 }}>Jan tilpasser sin tilgang til barnets alder og de konkrete situationer der er vanskelige. Forældrene er altid med i processen.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Barnet hører alt, husker det der sker, og har fuld kontrol undervejs. De fleste børn beskriver det som rart og afslappende, og for socialt ængstelige børn er det ofte en lettelse, at de ikke skal præstere eller forklare sig. De skal bare være med.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "700px" }}>
            <div>
              ...
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Nogle socialt ængstelige børn larmer ikke. De bliver bare væk. De rækker aldrig hånden op, undgår at læse højt og finder på undskyldninger ved fødselsdage og fritidsaktiviteter. Fordi de ikke skaber problemer, opdages deres mistrivsel ofte sent.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Frygten for at blive set</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Kernen er frygten for andres blikke: at sige noget forkert, rødme, blive grinet ad. Hjernens alarmsystem har koblet sociale situationer til fare, og reaktionen kommer automatisk, uanset hvor meget barnet ved, at der ikke sker noget.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Generthed er et temperament - barnet varmer langsomt op, men deltager. Social angst begrænser. Barnet går glip af venskaber, oplevelser og læring. Når undgåelsen styrer barnets valg, er det tid til at gøre noget.</p>
            </div>
          </div>
        </section>
