...
export default function Page() {
  return (
    <>
      <Header />
      <Head>
        <title>Dårligt selvbillede hos børn og unge | Gaarsdal Birkerød</title>
        <meta name="description" content="Dit barn er hård ved sig selv og tror ikke det er godt nok. Hypnoterapi arbejder med overbevisningerne under bevidst tænkning. Jan Gaarsdal, Birkerød." />
        <link rel="canonical" href="https://gaarsdal.net/selvbillede-born" />
        <meta property="og:title" content="Dårligt selvbillede hos børn og unge | Gaarsdal Birkerød" />
        <meta property="og:description" content="Dit barn er hård ved sig selv og tror ikke det er godt nok. Hypnoterapi arbejder med overbevisningerne under bevidst tænkning. Jan Gaarsdal, Birkerød." />
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "18px", color: "#555", maxWidth: "660px" }}>Det siger det er dumt, grimt, dårligt. Det sammenligner sig konstant med andre og taber. Ros hjælper ikke, det ryger ind af det ene øre og ud af det andet.</p>
        </section>
        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "15px", color: "#555", maxWidth: "700px" }}>Selvbillede sidder under bevidst tænkning. Hypnoterapi arbejder direkte der og erstatter de gamle overbevisninger med nye, som en reel oplevelse, ikke som positiv tænkning.</p>
        </section>
