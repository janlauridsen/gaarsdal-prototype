        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
            ...
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#555", lineHeight: 1.7 }}>Sammenligning er en grundlæggende neurologisk funktion. Sociale medier leverer konstant sammenligningsgrundlag med andres tilsyneladende bedste øjeblikke. For et barn med et lavt selvbillede forstærkes mønsteret massivt.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
