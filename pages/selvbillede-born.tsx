    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          <h1 style={{ fontSize: "34px", fontWeight: 600, lineHeight: 1.25, marginBottom: "20px" }}>Dit barn er hårdere ved sig selv end det ville være ved nogen anden</h1>
          <p style={{ fontSize: "18px", color: "#555", marginBottom: "16px", maxWidth: "660px" }}>Det siger det er dumt, grimt, dårligt til alt. Det sammenligner sig konstant med andre og kommer til kort. Du siger det er fantastisk og elsket. Det tror dig ikke. Ros glider af uden at bide. Det er ikke taknemmelighed det mangler. Det er en grundlæggende overbevisning om sin egen værdi der er skæv.</p>
          <p style={{ fontSize: "16px", color: "#666", maxWidth: "660px" }}>Selvbillede er ikke noget barnet vælger. Det er summen af overbevisninger opbygget over tid, og de sidder dybere end ord kan nå.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#555", lineHeight: 1.7 }}>Ros og bekræftelse opfattes som undtagelsen, der bekræfter reglen, når selvbilledet er lavt. Det er ikke negativ tænkning. Det er et filter, hjernen bruger uden at spørge. Hjernen sorterer information, så den passer til det eksisterende billede af sig selv.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Sociale medier forstærker det</h3>
              <p style={{ fontSize: "14px", color: "#555", lineHeight: 1.7 }}>Sammenligning er en grundlæggende neurologisk funktion. Sociale medier leverer konstant sammenligningsgrundlag med andres tilsyneladende bedste øjeblikke. For et barn med et lavt selvbillede forstærkes mønsteret kraftigt.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "10px" }}>Det er lært og kan ændres</h3>
              <p style={{ fontSize: "14px", color: "#555", lineHeight: 1.7 }}>Overbevisninger om ens egen værdi er ikke medfødte. De er formet af erfaringer, reaktioner fra omgivelserne og de historier, hjernen har skabt. De sidder dybt, men de kan ændres. Ikke ved at tale om dem, men ved at arbejde der hvor de sidder.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#f5f7fa", borderRadius: "10px" }}>
          ...
          <p style={{ fontSize: "15px", color: "#666", fontStyle: "italic" }}>Kilde: <a href="https://www.sst.dk" target="_blank" rel="noopener" style={{ color: "#5a7a8f", textDecoration: "underline" }}>Sundhedsstyrelsen.dk</a>, WHO Mental Health Report, Rosenberg Self-Esteem Research.</p>
        </section>
        ...
        <section style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <Link href="/krop-born" style={{ fontSize: "14px", color: "#5a7a8f", textDecoration: "none", padding: "6px 14px", border: "1px solid #5a7a8f", borderRadius: "20px" }}>Kropsutilfredshed</Link>
