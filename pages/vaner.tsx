    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          <h1 style={{ fontSize: "34px", fontWeight: 600, lineHeight: 1.25, marginBottom: "20px" }}>Du har besluttet dig mange gange. Og er alligevel tilbage til det gamle.</h1>
          <p style={{ fontSize: "18px", color: "#555", marginBottom: "16px", maxWidth: "660px" }}>Du ved præcis hvad du burde gøre anderledes. Du har masser af motivation. Men i det øjeblik vanen udløses, er beslutningen væk. Det er ikke mangel på viljestyrke. Det er fordi vaner sidder et andet sted end beslutninger.</p>
          <p style={{ fontSize: "16px", color: "#666", maxWidth: "660px" }}>Vaner kører i de basale dele af hjernen, ikke i den del der planlægger og bestemmer.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#555", lineHeight: 1.7 }}>Hjernen automatiserer adfærd der gentages. Det sparer ressourcer. Når en vane er etableret, kører den uden bevidst styring. I det øjeblik triggeren opstår, kører reaktionen hurtigere end den bevidste intention når at reagere.</p>
            </div>
            <div style={{ padding: "24px", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Vaner kører i de basale dele af hjernen, ikke i den del der beslutter og planlægger. Det er hele forklaringen på, hvorfor beslutninger ikke er nok. Du kan beslutte dig aldrig så meget; i det øjeblik triggeren opstår, kører den automatiske reaktion hurtigere end den bevidste intention.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Hypnose arbejder direkte med den automatiske reaktion. I stedet for at styrke viljestyrken, som alligevel taber til automatikken, afkobles selve forbindelsen mellem triggeren og handlingen. Det, der før udløste vanen, mister sin automatiske kraft.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Derfor handler det ikke om at kæmpe mod vanen hele dagen. Når koblingen er ændret, opstår trangen ikke på samme måde, og det, der før krævede konstant selvkontrol, bliver i stedet ubesværet.</p>
          <p style={{ fontSize: "15px", color: "#666", maxWidth: "700px" }}>Der arbejdes også med det behov, vanen dækker. De fleste vaner gør noget for os, giver ro, pause, trøst eller stimulation, og når behovet mødes på en sundere måde, falder den gamle vane lettere bort.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "700px" }}>
            <div>
              ...
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7, margin: 0 }}>Motivationen er høj i starten, og det føles let. Men motivation svinger, og når den daler, står kun automatikken tilbage. Det er derfor det typisk skrider efter en uge eller to, ikke på grund af svaghed, men på grund af hvordan vaner er bygget.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Triggeren udløser før tanken</h3>
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7, margin: 0 }}>En bestemt situation, følelse eller tid på dagen udløser vanen, før du når at tænke. Du opdager den først, når den allerede er i gang. Arbejdet retter sig mod netop det øjeblik, hvor triggeren rammer.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Vanen dækker et behov</h3>
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7, margin: 0 }}>Bag de fleste vaner ligger et behov: at dæmpe stress, fylde en tomhed, skabe en pause. Fjernes vanen uden at behovet adresseres, vender den tilbage eller erstattes af en anden. Derfor arbejdes der med behovet, ikke kun handlingen.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Skam gør det værre</h3>
              <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7, margin: 0 }}>Hver gang du falder tilbage, kommer skammen, og skam øger ofte netop den uro, vanen skulle dæmpe. Det bliver en selvforstærkende cirkel. At bryde den kræver, at man arbejder et andet sted end ved selvbebrejdelse.</p>
            </div>
          </div>
        </section>
