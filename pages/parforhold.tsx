    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "18px", color: "#555", marginBottom: "16px", maxWidth: "660px" }}>I kender godt mønsteret. En situation opstår, reaktionerne kører af sig selv, og bagefter ved I begge at det gik galt igen. Samtaler om det hjælper midlertidigt. Men næste gang det samme trigger dukker op, starter sekvensen forfra.</p>
          <p style={{ fontSize: "16px", color: "#666", maxWidth: "660px" }}>Konflikter i parforholdet handler sjældent om det de tilsyneladende handler om. De handler om de individuelle reaktionsmønstre, hver part bringer med ind - og de kan ændres.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Hypnoterapi arbejder med de automatiske reaktioner den enkelte bringer ind i parforholdet. Det handler ikke om at lære nye teknikker til at kommunikere bedre - det handler om at ændre selve den reaktion der sker, inden du når at tænke over det.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Jan tilbyder en fælles indledende session for par, hvor mønstrene kortlægges og begges oplevelse høres. Herefter arbejdes der individuelt - med den enes eller begges reaktioner, afhængigt af hvad der giver mest mening.</p>
          <p style={{ fontSize: "15px", color: "#666", maxWidth: "700px" }}>Dette er ikke klassisk parterapi, men individuel hypnoterapi med fokus på de mønstre der påvirker relationen. Mange oplever at arbejdet med egne reaktioner ændrer parforholdet mærkbart.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Gratis forsamtale (30 min).</strong> Vi taler om hvad der er svært, hvornår mønstrene opstod, og hvad I har prøvet. Begge kan deltage, eller kun én. Her afklares om hypnoterapi er den rette tilgang og for hvem.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Fælles session (valgfrit, 90 min).</strong> For par der ønsker det tilbydes en fælles kortlægningssession, hvor begges reaktionsmønstre og oplevelse af forholdet beskrives. Dette er ikke konfliktmægling - det er kortlægning af hvad der driver mønstrene.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Individuelle sessioner (90 min første, ca. 60 min opfølgning).</strong> Det egentlige hypnoterapiarbejde foregår individuelt - med den enes reaktioner, eller begges i parallelle forløb. Mange oplever at forholdet ændrer sig mærkbart allerede mens det individuelle arbejde pågår.</p>
        ...
        <section style={{ marginBottom: "60px", padding: "28px 32px", background: "#fdf6f0", borderRadius: "10px", border: "1px solid #ecd9c6" }}>
          ...
          <p style={{ fontSize: "15px", color: "#555", maxWidth: "700px", margin: 0 }}>Hypnoterapi kan ikke garantere at et parforhold bevares eller reddes. Det ændrer individuelle reaktionsmønstre - og det er et nyt udgangspunkt, uanset hvilken retning forholdet derefter tager. Ved vold i nære relationer eller alvorlige tillidssvigt kræves typisk et mere specialiseret forløb - kontakt din læge eller en specialiseret rådgivning.</p>
        </section>

        <section style={{ marginBottom: "48px", padding: "32px", background: "#f9fafb", borderRadius: "10px", borderLeft: "3px solid #5a7a8f" }}>
          <h2 style={{ fontSize: "18px", fontWeight: 600, marginBottom: "12px" }}>Jan Gaarsdal, hypnoterapeut i Birkerød</h2>
          <p style={{ fontSize: "15px", color: "#555", marginBottom: "16px", lineHeight: 1.7 }}>Jan arbejder med parforholdsudfordringer som individuelle reaktionsmønstre. Han tilbyder fælles kortlægningssessioner og individuelle forløb - og møder det der er svært i parforholdet uden at dømme eller placere skyld.</p>
        ...
        <section style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <Link href="/agteskab" style={{ fontSize: "14px", color: "#5a7a8f", textDecoration: "none", padding: "6px 14px", border: "1px solid #5a7a8f", borderRadius: "20px" }}>Skema: Hvad savner jeg i mit ægteskab? →</Link>
