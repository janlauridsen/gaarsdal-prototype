...
export default function Page() {
  return (
    <>
      <Header />
      <Head>
        <title>Kropsutilfredshed hos børn og unge | Gaarsdal Birkerød</title>
        ...
        <meta property="og:title" content="Kropsutilfredshed hos børn og unge | Gaarsdal Birkerød" />
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "18px", color: "#555", maxWidth: "660px" }}>Det siger det er for tykt, for grimt, for lille eller for stort. Det vil ikke med til stranden. Det sammenligner sig konstant. Du siger det er smukt som det er. Det tror dig ikke.</p>
        </section>
        <section style={{ marginBottom: "60px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "16px" }}>Hvad hypnoterapi gør</h2>
          <p style={{ fontSize: "15px", color: "#555", maxWidth: "700px" }}>Kropsutilfredshed er et forvredet selvbillede der sidder dybere end spejlet. Hypnoterapi arbejder med selvbilledet under bevidst tænkning, det er en af de mest markante forandringer metoden kan skabe hos unge.</p>
        </section>
