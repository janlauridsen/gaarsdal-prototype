      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#2C2A28" }}>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#F5F3EE", borderRadius: "10px" }}>
          ...
          <p style={{ fontSize: "16px", color: "#6B675F", fontStyle: "italic", lineHeight: 1.7 }}>
            Kilde: Nature, maj 2025. <a href="https://www.sst.dk" target="_blank" rel="noopener" style={{ color: "#5A7049", textDecoration: "underline" }}>Sundhedsstyrelsen.dk</a>.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Søvnproblemer hos voksne er sjældent et søvnproblem i sig selv. Det er et nervesystem, der er for aktiveret til at slippe ned. Du er træt, men i det øjeblik du lægger dig, tænder systemet: tankerne starter, kroppen er på vagt. Sengen er blevet koblet til uro i stedet for ro.</p>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Hypnose arbejder direkte med den kobling. Den hypnotiske tilstand og den naturlige indsovning aktiverer de samme neurologiske mekanismer: en gradvis nedlukning hvor opmærksomheden vender indad og kroppen falder til ro. I sessionen lærer nervesystemet vejen ned igen.</p>
          <p style={{ fontSize: "16px", marginBottom: "16px", maxWidth: "700px", lineHeight: 1.7 }}>Det afgørende er, at det ikke er en teknik du skal huske at bruge klokken 23. Det er en ny automatisk reaktion: sengen og mørket kommer igen til at betyde ro frem for alarm. For mange kommer resultaterne relativt hurtigt, fordi søvn er kroppens naturlige tilstand, når alarmberedskabet slipper.</p>
          <p style={{ fontSize: "16px", color: "#6B675F", maxWidth: "700px", lineHeight: 1.7 }}>Samtidig arbejdes der med det, der holder dig vågen: bekymringerne der får frit løb i stilheden, eller den vedvarende uro der ikke vil falde til ro.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "700px" }}>
            <div>
              ...
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Du ligger vågen i timevis selvom du er udmattet. Tankerne kører, kroppen vil ikke slippe. Ofte er sengen blevet en kampplads, og selve det at prøve at sove holder dig vågen.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Du vågner om natten</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Du falder i søvn, men vågner kl. 3 og kan ikke falde i søvn igen. Hjernen tænder med det samme, ofte med bekymringer eller en diffus uro. Nattevågenhed er et af de tydeligste tegn på et overaktiveret nervesystem.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Bekymringer ved sengetid</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Når dagens distraktioner forsvinder, får tankerne frit løb. Sengen bliver det sted, hvor alt det uafsluttede melder sig. Det er ofte angst eller stress, der viser sig om natten, og begge dele kan der arbejdes med.</p>
            </div>
            <div>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "6px" }}>Du sover, men er aldrig udhvilet</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7, margin: 0 }}>Du får måske timerne, men vågner træt. Søvnen er overfladisk, fordi nervesystemet aldrig kommer helt ned i den dybe, restituerende søvn. Her arbejdes der med selve dybden, ikke kun med at falde i søvn.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "60px", padding: "28px 32px", background: "#F7F1E8", borderRadius: "10px", border: "1px solid #E6D9C2" }}>
          ...
          <p style={{ fontSize: "16px", color: "#4A463F", maxWidth: "700px", margin: 0, lineHeight: 1.7 }}>Ved mistanke om søvnapnø (kraftig snorken med vejrtrækningspauser), rastløse ben eller hvis søvnproblemet er opstået pludseligt uden årsag, bør du tale med din læge, så fysiske årsager udelukkes. Hypnoterapi arbejder med de uro- og mønsterdrevne søvnproblemer.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Kan hypnose hjælpe mod søvnproblemer?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Ja. Hypnotisk tilstand og søvnindledning aktiverer de samme neurologiske mekanismer. Hypnoterapi lærer nervesystemet at slippe ned i ro, så søvnen kommer naturligt i stedet for at skulle tvinges frem.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Hvor hurtigt virker hypnose mod søvnløshed?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Nogle mærker en forskel hurtigt, andre har brug for længere tid. Da søvnproblemer ofte handler om en lært association mellem sengen og uro, kan ændringen af det mønster ske relativt hurtigt.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Hvorfor virker gode søvnvaner ikke for mig?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Fordi søvnproblemer sjældent handler om vaner alene. De handler om et nervesystem i beredskab og en hjerne der har lært at forbinde sengen med uro. Den association kan ikke ændres ved viljestyrke eller rutiner alene.</p>
            </div>
            <div style={{ borderBottom: "1px solid #E3DFD5", paddingBottom: "16px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "8px", color: "#2C2A28" }}>Er hypnose mod søvn det samme som søvnmedicin?</h3>
              <p style={{ fontSize: "16px", color: "#4A463F", lineHeight: 1.7 }}>Nej. Søvnmedicin dæmper symptomet midlertidigt, mens hypnoterapi arbejder med årsagen til at nervesystemet ikke slipper ned. Hypnose har ingen bivirkninger og skaber ikke afhængighed.</p>
            </div>
          </div>
        </section>
