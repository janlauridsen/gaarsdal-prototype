    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "18px", color: "#555", marginBottom: "16px", maxWidth: "660px" }}>Hver måned er en følelsesmæssig rutsjebane. Håb, ventetid, skuffelse — og så forfra. Fertilitetsbehandling fylder alt: tanker, samtaler, kroppen, parforholdet. Du har ikke kontrol over udfaldet. Og det er det sværeste.</p>
          <p style={{ fontSize: "16px", color: "#666", maxWidth: "660px" }}>Fertilitetsstress er ikke noget du skal tænke dig ud af. Det er en reel belastning af nervesystemet — og det fortjener at blive taget alvorligt.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Hypnoterapi arbejder med den stress og uro et fertilitetsforløb skaber. Ikke for at love et bestemt resultat, men for at hjælpe dig med at bære processen, finde ro i ventetiden og reducere den belastning der påvirker både dig og kroppen.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}>Konkret arbejdes der med at bringe nervesystemet ned fra konstant beredskab — så søvnen forbedres, angsten reduceres og du har mere at give til dig selv og dit parforhold. Mange beskriver at de første gang i lang tid kan slippe fokus på fertilitetsforløbet i selve sessionen.</p>
          <p style={{ fontSize: "15px", color: "#666", maxWidth: "700px" }}>Jan tilbyder individuelle sessioner og en fælles indledende session for par der ønsker det.</p>
        </section>
        ...
        <section style={{ marginBottom: "60px" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Gratis forsamtale (30 min).</strong> Vi taler om hvad I oplever, hvor I er i forløbet, og hvad der er sværest. For par kan begge deltage. Her afklares om hypnoterapi giver mening som næste skridt.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Individuelle sessioner (90 min første, ca. 60 min opfølgning).</strong> Sessioner tilpasses hvad der fylder mest — angst, søvn, parforholdsbelastning eller den generelle psykiske robusthed under forløbet.</p>
          <p style={{ fontSize: "15px", marginBottom: "16px", maxWidth: "700px" }}><strong>Tidspunkt i forløbet.</strong> Hypnoterapi kan starte på ethvert tidspunkt — inden første behandling, midt i et IVF-forløb, eller efter en skuffelse. Mange vælger at have et eller to sessioner samlet om behandlingscyklussens tidspunkter.</p>
          <p style={{ fontSize: "15px", color: "#666", maxWidth: "700px" }}>Sessioner foregår fysisk i Birkerød eller online. Se <Link href="/priser" style={{ color: "#5a7a8f" }}>priser</Link>.</p>
        </section>
        ...
        <section style={{ marginBottom: "48px", padding: "32px", background: "#f9fafb", borderRadius: "10px", borderLeft: "3px solid #5a7a8f" }}>
          ...
          <p style={{ fontSize: "15px", color: "#555", marginBottom: "16px", lineHeight: 1.7 }}>Jan arbejder med enkeltpersoner og par under fertilitetsforløb. Han møder det der er svært uden at love resultater — og tilbyder et rum der er adskilt fra klinikkens venteværelse, resultater og procedurer.</p>
        ...
        <section style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <Link href="/overgangsalder" style={{ fontSize: "14px", color: "#5a7a8f", textDecoration: "none", padding: "6px 14px", border: "1px solid #5a7a8f", borderRadius: "20px" }}>Overgangsalder →</Link>
