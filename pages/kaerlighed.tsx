    ...
    <>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 20px 80px", fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", lineHeight: 1.7, color: "#333" }}>
        ...
        <section style={{ marginBottom: "60px", padding: "32px", background: "#f0f4f8", borderRadius: "10px", borderLeft: "3px solid #5a7a8f" }}>
          ...
          <p style={{ fontSize: "15px", marginBottom: "12px", maxWidth: "700px" }}>Måske har du læst om tilknytningsmønstre, lyttet til podcasts, talt med venner eller taget en test online. Du kan sætte ord på det. Du genkender dig selv i det ængstelige eller undvigende mønster.</p>
